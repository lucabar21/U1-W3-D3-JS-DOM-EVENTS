...
form.addEventListener("submit", function (e) {
  ...
  const inputListElement = document.getElementById("element");

  const myData = {
    elementList: inputListElement.value,
  };
  generateElement(myData);
